  ...
  <div class="flex flex-col h-screen ">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <main class="flex-1 p-4 overflow-auto flex items-center justify-center ">
        ...
        >
          <Grid :grid="grid" @toggle-cell="toggleCellState" />
        </div>
      </main>
    </div>

    <footer class="bg-gray-800 text-gray-400 text-sm text-center py-2">
      © 2025 · <a href="https://github.com/your-repo" class="underline hover:text-gray-200">Source on GitHub</a>
    </footer>
